...
class WhynotShopperImpact extends React.Component {
    render() {
        const dayCount = this.props.impactData.dayCount.length && this.props.impactData.dayCount[0].hasOwnProperty('days_with_cart_reduction') ? this.props.impactData.dayCount[0].days_with_cart_reduction * 1 : "";
        return (
                ...
                <div className="card d-flex flex-row flex-wrap">
                    <div className="col-lg-12 col-md-12">
                        <div className="header pb-0 pl-1">
                            <h2 className="pb-3">Cart Reduction Data {this.props.impactData.industryStd ? <span className="text-muted industryAvg">Based on Industry Avg.</span> : ""}</h2>
                        </div>
                    </div>
                    <div className="col-lg-12 col-md-12">
                        {this.props.impactData.data && this.props.impactData.data.length && !this.props.impactData.industryStd ?
                            <div className="body table-responsive scrollableTableFixedHeader cardScrollBar m-r-5 clearfix">
                                <table className="table table-striped">
                                    <thead>
                                        <tr>
                                            <th>Converting Sessions BreakDown</th>
...
export default WhynotShopperImpact;
