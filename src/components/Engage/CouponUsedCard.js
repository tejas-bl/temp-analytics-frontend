...
class CouponUsedCard extends React.Component {
    render() {
        return (
                ...
                <div className="card d-flex flex-row flex-wrap">
                    <div className="col-lg-12 col-md-12">
                        <div className="header pb-0">
                            <h2 className="pb-0">Coupons used</h2>
                        </div>
                    </div>
                    <div className="col-lg-12 col-md-12">
                        {this.props.couponUsedData.Dataset && this.props.couponUsedData.Dataset.length > 0 ?
                            <div className="body table-responsive scrollableTableFixedHeader cardScrollBar m-r-5 clearfix">
                                <DataTable data={this.props.couponUsedData.Dataset} columns={this.props.couponUsedData.columnConfig} />
