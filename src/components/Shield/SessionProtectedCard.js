...
class SessionProtectedCard extends React.Component {
	constructor(props) {
		super(props);
		this.state = {
	...
	chartPlace = () => {
		...
		var chartDom = document.getElementById('SessionProtectedCard' + index);
	...
	render() {
		return (
			// <div className="col-lg-4 col-md-4">
				<div className="card text-center shield_100_card sessionProtectedDiv">
					<div className="header pb-0">
						<h2>No. of Sessions Protected</h2>
						<hr />
					</div>
					<div className="body pt-0">
						<div className="number badge badge-info text-secondary">
							<h3>
								<strong>
								{!this.props.protectedSessionsLoading && this.props.protectedSessions !== undefined && convertNumbertoCurrencyFormat(this.props.protectedSessions, '')}
								</strong>
							</h3>
						</div>
					</div>
					<div
						id={'SessionProtectedCard' + this.props.index}
						className="sparkline"
