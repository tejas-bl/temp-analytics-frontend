...
import { updateAnalytics } from "../../api/Dashboard/OldDB";
import { Modal } from "react-bootstrap";

class EditAnalyticsModal extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            analytics: this.props.data,
            formField: {
    ...
    async onUpdateAnalytics(data) {
        ...
        const updatedUser = await updateAnalytics(data, headerConfig);
    ...
    setDropdownFieldValue(e, data) {
        let foundData = false;
        if (e !== undefined && e.length && e !== null && data !== null) {
            foundData = e.find((opt) => {
                                    ...
                                    <div className="body" id="addAnalyticsBody">
                                        <Formik
                                            ...
                                            initialValues={{
                                                ...
                                                internal_web_property_id: data.internal_web_property_id,
                                                ...
                                                account_credentials_file: data.account_credentials_file,
                                                account_secret_file: data.account_secret_file,
                                                ga_web_id: data.ga_web_id
                                            }}
                                            onSubmit={async (values, { setSubmitting }) => {
                                                ...
                                                await this.onUpdateAnalytics(data);
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="form-group col-md-6 col-lg-6">
                                                            ...
                                                            <Select
                                                                ...
                                                                values={[this.setDropdownFieldValue(this.props.existingAnalyticsClientDetails.profile_id, data.profile_id)]}
                                                                onChange={(e) => {
                                                        ...
                                                        <div className="form-group col-md-6 col-lg-6">
                                                            ...
                                                            <Select
                                                                ...
                                                                values={[this.setDropdownFieldValue(this.props.existingAnalyticsClientDetails.internal_web_property_id, data.internal_web_property_id)]}
                                                                onChange={(e) => {
                                                                    if (e && e.length && e[0].hasOwnProperty('label')) {
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="form-group col-md-6 col-lg-6">
                                                            ...
                                                            <Select
                                                                ...
                                                                values={[this.setDropdownFieldValue(this.props.existingAnalyticsClientDetails.platform, data.platform)]}
                                                                onChange={(e) => {
                                                                    if (e && e.length && e[0].hasOwnProperty('label')) {
                                                        ...
                                                        <div className="form-group col-md-6 col-lg-6">
                                                            ...
                                                            <Select
                                                                ...
                                                                values={[this.setDropdownFieldValue(this.props.existingAnalyticsClientDetails.event_category, data.event_category)]}
                                                                onChange={(e) => {
                                                                    if (e && e.length && e[0].hasOwnProperty('label')) {
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="form-group col-md-6 col-lg-6">
                                                            ...
                                                            <Select
                                                                ...
                                                                values={[this.setDropdownFieldValue(this.props.existingAnalyticsClientDetails.event_action, data.event_action)]}
                                                                onChange={(e) => {
                                                                    if (e && e.length && e[0].hasOwnProperty('label')) {
                                                        ...
                                                        <div className="form-group col-md-6 col-lg-6">
                                                            ...
                                                            <Select
                                                                ...
                                                                values={[this.setDropdownFieldValue(this.props.existingAnalyticsClientDetails.metrics, data.metrics)]}
                                                                onChange={(e) => {
                                                                    if (e && e.length && e[0].hasOwnProperty('label')) {
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="form-group col-md-6 col-lg-6">
                                                            ...
                                                            <Select
                                                                ...
                                                                values={[this.setDropdownFieldValue(this.props.existingAnalyticsClientDetails.persona_id, data.persona_id)]}
                                                                onChange={(e) => {
                                                                    if (e && e.length && e[0].hasOwnProperty('label')) {
                                                        ...
                                                        <div className="form-group col-md-6 col-lg-6">
                                                            ...
                                                            <Select
                                                                ...
                                                                values={[this.setDropdownFieldValue(this.props.existingAnalyticsClientDetails.event_label, data.event_label)]}
                                                                onChange={(e) => {
                                                                    if (e && e.length && e[0].hasOwnProperty('label')) {
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="form-group col-md-6 col-lg-6">
                                                            ...
                                                            <Select
                                                                ...
                                                                values={[this.setDropdownFieldValue(this.props.existingAnalyticsClientDetails.persona_group, data.persona_group)]}
                                                                onChange={(e) => {
                                                                    if (e && e.length && e[0].hasOwnProperty('label')) {
                                                        ...
                                                        <div className="form-group col-md-6 col-lg-6">
                                                            ...
                                                            <Select
                                                                ...
                                                                values={[this.setDropdownFieldValue(this.props.existingAnalyticsClientDetails.segments, data.segments)]}
                                                                onChange={(e) => {
                                                                    if (e && e.length && e[0].hasOwnProperty('label')) {
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="form-group col-md-6 col-lg-6">
                                                            ...
                                                            <Select
                                                                ...
                                                                values={[this.setDropdownFieldValue(this.props.existingAnalyticsClientDetails.account_credentials_file, data.account_credentials_file)]}
                                                                onChange={(e) => {
                                                                    if (e && e.length && e[0].hasOwnProperty('label')) {
                                                        ...
                                                        <div className="form-group col-md-6 col-lg-6">
                                                            ...
                                                            <Select
                                                                ...
                                                                values={[this.setDropdownFieldValue(this.props.existingAnalyticsClientDetails.account_secret_file, data.account_secret_file)]}
                                                                onChange={(e) => {
                                                                    if (e && e.length && e[0].hasOwnProperty('label')) {
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="form-group col-md-6 col-lg-6">
                                                            ...
                                                            <Select
                                                                ...
                                                                values={[this.setDropdownFieldValue(this.props.existingAnalyticsClientDetails.product, data.product)]}
                                                                onChange={(e) => {
                                                                    if (e && e.length && e[0].hasOwnProperty('label')) {
                                                        ...
                                                        <div className="form-group col-md-6 col-lg-6">
                                                            ...
                                                            <Select
                                                                ...
                                                                values={[this.setDropdownFieldValue(this.props.existingAnalyticsClientDetails.ga_web_id, data.ga_web_id)]}
                                                                onChange={(e) => {
                                                                    if (e && e.length && e[0].hasOwnProperty('label')) {
