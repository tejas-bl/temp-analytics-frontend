...
import { deleteScreenshot } from "../../api/Dashboard/Reports";

class DeleteScreenshotModal extends React.Component {
    constructor(props) {
        super(props);
    }

    async handleSceenshotDelete(data) {
        ...
        const deleted = await deleteScreenshot(data, headerConfig);
        ...
        return (
            <Modal size={size} show={show} onHide={onClose} className="deleteuserModal">
                <Modal.Header closeButton>
                    <Modal.Title>Delete Screenshot</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <div className="d-flex flex-row justify-content-between flex-wrap">
                        <div className="col-lg-12 col-md-12 col-sm-12">
                            <div className="">
                                <div className="body">
                                    Do you want to delete {this.props.data.screenshot_name} screenshot?
                                    <div className="col-md-12 text-left mt-3 pl-0 pr-0">
                                        <button
                                            className="btn btn-danger text-center mr-3"
                                            onClick={() => this.handleSceenshotDelete(this.props.data)}
                                        >
                                            Delete
                                        </button>
