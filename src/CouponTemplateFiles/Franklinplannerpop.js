function createTemplate(engageDeals) {
  ...
  template +=
      '<div style="padding: 2em;"><div style="margin: 0 auto;" class="bl-left"><div class="blue-bg" style="background: #fff;color: #fff;margin-bottom: 15px;text-align: center;"><img alt="logo" src="https://shop.franklinplanner.com/static/images/respNav/fplogo-lg.jpg" title="logo" style=" height: auto; max-width: 230px; padding: 10px 0;"> </div>';
