function createTemplate(engageDeals) {
  ...
  template +=
    '<div style="padding: 2em;"><div style="margin: 0 auto;" class="bl-left"><div class="blue-bg" style="background: #293897;color: #fff;margin-bottom: 15px;text-align: center;"><img alt="Blair" src="https://www.blair.com/static/images/blair/logo_white.svg" title="Blair" style=" height: auto; max-width: 125px; padding: 10px 0;"> </div><p id="bl-ppe-title-msg" style="display:none"> <span class="bl-bold">Oops! Looks like your code didn\'t work.</span> <span class="bl-grey">Just click the \'Apply\' button below and the promo code will be applied automatically.</span> </p></div> <div style="height:15px;"></div>';
