...
export const dashboardOverallPieChart = {
  title: {
    text: "Brandlock YTD Revenue Recovered",
    subtext: "8% High then last month",
    left: "center",
  },
  color: ["#20c997", "#e83e8c", "#6f42c1", "#ffc107"],
  tooltip: {
    trigger: "item",
  ...
  legend: {
    ...
    data: [
      "Shield",
      "Engage WC",
      "Engage Why Not Shopper",
      "Engage Coupon Runner",
    ],
  },
  series: [
    {
      ...
      center: ["50%", "60%"],
      data: [
        { value: 84, name: "Shield" },
        { value: 15, name: "Engage WC" },
        { value: 5, name: "Engage Why Not Shopper" },
        { value: 15.40, name: "Engage Coupon Runner" },
      ],
      emphasis: {
        itemStyle: {
          shadowBlur: 10,
...
export const sessionAttributionHijackingPieChart = {
  title: {
    text: "Session Attribution Hijacking",
    subtext: "Recycled User Session vs First Page User Session",
    left: "center",
  },
  color: ["#769ccd", "#374649"],
  tooltip: {
  ...
  legend: {
    ...
    bottom: "bottom",
    data: [
      "First Page User Session",
      "Recycled User Session",
    ],
  },
  series: [
    {
      ...
      center: ["50%", "50%"],
      data: [
        { value: 60.7, name: "First Page User Session" },
        { value: 39.3, name: "Recycled User Session" },
      ],
      emphasis: {
        itemStyle: {
          shadowBlur: 10,
...
export const orderAttributionHijackingPieChart = {
  title: {
  ...
  series: [
    {
      ...
      center: ["50%", "50%"],
      data: [
        { value: 88.7, name: "First Page User Conversion" },
        { value: 11.3, name: "Recycled User Session" },
      ],
      emphasis: {
        itemStyle: {
          shadowBlur: 10,
