...
/* BRANDLOCK DATA START  */
export const logsData = [
  {
    heading: "Listening Phase | Protection Phase​",
    icon: "fa fa-thumbs-o-up",
  },
  {
    heading: "Split Changes",
    icon: "fa fa-user",
  },
  {
    heading: "Personas Activated",
    icon: "fa fa-question-circle",
  },
  {
    heading: "Coupons Added​",
...
export const upComingActionsNeededData = [
  {
    title: "Coupons Expiring​​​",
    image:avatar1,
  },
  {
    title: "Split Changes Needed (When we reach stat signifigance we ask them to move to 90/0 or 100.​​",
    image: avatar2,
  },
  {
    title: "Coupons mapped to WC expiring​​",
    image: avatar3,
  },
  {
    title: "Coupons Added​",
...
export const shieldAndPersonaData = [
  {
    heading : "Which Shield blocks and persona are active​",
    smallText : "Description text here...", 
    shield : {
      shieldTitle : "Active Shield Blocks",
      activeShieldBlocks : [
        {
        ...
        {
          title: "Callback and Coupon Extensions",
          status: false,
        },
        {
          title: "Malware & Adware",
    ...
    persona : {
      personaTitle : "Active Persona",
      activePersonaBlocks : [
        {
          title: "Malware & Adware 11",
          status: true,
        },
        {
          title: "Callback and Coupon Extensions",
